...
func (_c *AccountCreate) SetNillableProvider(v *account.Provider) *AccountCreate {
	if v != nil {
		_c.SetProvider(*v)
	}
	return _c
...
func (_c *AccountCreate) SetMailVerified(v bool) *AccountCreate {
	_c.mutation.SetMailVerified(v)
	return _c
}

// SetNillableMailVerified sets the "mail_verified" field if the given value is not nil.
func (_c *AccountCreate) SetNillableMailVerified(v *bool) *AccountCreate {
	if v != nil {
		_c.SetMailVerified(*v)
	}
	return _c
}
...
func (_c *AccountCreate) AddSessionIDs(ids ...string) *AccountCreate {
...
func (_c *AccountCreate) defaults() {
	...
	if _, ok := _c.mutation.MailVerified(); !ok {
		v := account.DefaultMailVerified
		_c.mutation.SetMailVerified(v)
	}
...
func (_c *AccountCreate) check() error {
	...
	if _, ok := _c.mutation.MailVerified(); !ok {
		return &ValidationError{Name: "mail_verified", err: errors.New(`ent: missing required field "Account.mail_verified"`)}
	}
...
func (_c *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.MailVerified(); ok {
		_spec.SetField(account.FieldMailVerified, field.TypeBool, value)
		_node.MailVerified = value
	}
