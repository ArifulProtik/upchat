...
func (_q *SessionQuery) QueryOwner() *AccountQuery {
...
func (_q *SessionQuery) WithOwner(opts ...func(*AccountQuery)) *SessionQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *SessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Session, error) {
	...
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *Session, e *Account) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SessionQuery) loadOwner(ctx context.Context, query *AccountQuery, nodes []*Session, init func(*Session), assign func(*Session, *Account)) error {
