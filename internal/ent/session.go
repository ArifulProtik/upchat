...
func (e SessionEdges) OwnerOrErr() (*Account, error) {
	if e.Owner != nil {
		return e.Owner, nil
...
func (*Session) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case session.FieldID, session.FieldAccountID, session.FieldToken, session.FieldIPAddress, session.FieldUserAgent:
...
func (_m *Session) QueryOwner() *AccountQuery {
