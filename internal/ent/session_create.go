...
func (_c *SessionCreate) SetAccountID(v string) *SessionCreate {
	_c.mutation.SetAccountID(v)
	return _c
}

// SetNillableAccountID sets the "account_id" field if the given value is not nil.
func (_c *SessionCreate) SetNillableAccountID(v *string) *SessionCreate {
	if v != nil {
		_c.SetAccountID(*v)
	}
	return _c
...
func (_c *SessionCreate) SetNillableOwnerID(id *string) *SessionCreate {
	if id != nil {
		_c = _c.SetOwnerID(*id)
	}
	return _c
...
func (_c *SessionCreate) SetOwner(v *Account) *SessionCreate {
