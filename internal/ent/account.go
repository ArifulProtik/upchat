...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldUserID, account.FieldProvider, account.FieldEmail, account.FieldPassword:
	...
	for i := range columns {
		...
		case account.FieldMailVerified:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field mail_verified", values[i])
			} else if value.Valid {
				_m.MailVerified = value.Bool
			}
		default:
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("mail_verified=")
	builder.WriteString(fmt.Sprintf("%v", _m.MailVerified))
	builder.WriteByte(')')
