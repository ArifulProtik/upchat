...
// MailVerified applies equality check predicate on the "mail_verified" field. It's identical to MailVerifiedEQ.
func MailVerified(v bool) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldMailVerified, v))
}
...
// MailVerifiedEQ applies the EQ predicate on the "mail_verified" field.
func MailVerifiedEQ(v bool) predicate.Account {
	return predicate.Account(sql.FieldEQ(FieldMailVerified, v))
}

// MailVerifiedNEQ applies the NEQ predicate on the "mail_verified" field.
func MailVerifiedNEQ(v bool) predicate.Account {
	return predicate.Account(sql.FieldNEQ(FieldMailVerified, v))
}
